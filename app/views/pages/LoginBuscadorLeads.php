<div class="container-fluid ColorSecundario"><br><br><br>
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-4 ColorTextoOscuro text-center shadow p-3 mb-5"><br><br>
            ...
            <form action="./ValidacionLogin" method="post">
                ...
                <input type="submit" class="btn btn-success btn-lg" name="btnValidacionBuscadorLeads" value="Enviar">
            </form>
        </div>
        <div class="col-12 col-sm-3 col-md-4 col-lg-4"></div>
    </div>
</div>
<div class="container-fluid ColorPrincipal text-white">
    <div class="container">
        <hr>
        <div class="row">
