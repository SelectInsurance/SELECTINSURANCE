                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 RadioDeBordes ColorPrincipalTranslucido">
                            <div class="container"><br><br>
                                ...
                                <form action="./SantiagoCruz" method="post">
                                    <div class="row">
...
<div class="container" id="Cotizador">
    <h2 class="text-center ColorTextoOscuro">Cotiza con su agente personalizado <b>Santiago Cruz</b></h2>
                ...
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body ColorSecundario">
                            ...
                            <img class="img-fluid shadow p-3 mb-5 " src="appiews\assets\img\imgmodales\Familia.jpg" alt="Seguros Familiares" title="Seguros Familiares">
                        </div>
                        <div class="modal-footer bg-light">
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
                            <a href="#Cotizador" class="btn btn-success">Cotizar</a>
                ...
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body ColorSecundario">
                            ...
                            <img class="img-fluid shadow p-3 mb-5 " src="appiews\assets\img\imgmodales\Compañias.png" alt="Seguros Compañias" title="Seguros Compañias">
                        </div>
                        <div class="modal-footer bg-light">
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
                            <a href="#Cotizador" class="btn btn-success">Cotizar</a>
                ...
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body ColorSecundario">
                            ...
                            <img class="img-fluid shadow p-3 mb-5 " src="appiews\assets\img\imgmodales\SeguroSalud.png" alt="Seguros de Salud" title="Seguros de Salud">
                        </div>
                        <div class="modal-footer bg-light">
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
                            <a href="#Cotizador" class="btn btn-success">Cotizar</a>
                ...
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body ColorSecundario">
                            ...
                            <img class="img-fluid shadow p-3 mb-5 " src="appiews\assets\img\imgmodales\Planes Retiro.png" alt="Planes de Retiro" title="Planes de Retiro">
                        </div>
                        <div class="modal-footer bg-light">
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
                            <a href="#Cotizador" class="btn btn-success">Cotizar</a>
                ...
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body ColorSecundario">
                            ...
                            <img class="img-fluid shadow p-3 mb-5 " src="appiews\assets\img\imgmodales\Soluciones Financieras.png" alt="Soluciones Financieras" title="Soluciones Financieras">
                        </div>
                        <div class="modal-footer bg-light">
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
                            <a href="#Cotizador" class="btn btn-success">Cotizar</a>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3 col-lg-3">
                ...
                <p class="lh-lg">
                    Whatsapp: +573166857000 <br>

                    Telefono: <a href="tel:3052138202" title="Telefono">3052138202</a> <br>

                    Email: <a href="mailto:asdasd@gmail.com">asdasd@gmail.com</a> <br>

                    Dirección: 7791 NW 46 ST. SUITE 112 DORAL, FL 33166 <br>

                    Redes: <p><a href="https://instagram.com/prueba" title="Mi Instagram" target="__blank"><i class="fab fa-instagram fa-2x"></i></a> <a href="https://facebook.com/prueba" title="Mi Facebook" target="__blank"><i class="fab fa-facebook fa-2x"></i></a></p> <br>
                </p>
            </div>
...
<blockquote>
	<a href="https://api.whatsapp.com/send?phone=+573166857000" target="__blank">
		<p>
