...
<div class="container" id="Cotizador">
    <h2 class="text-center ColorTextoOscuro">Cotiza con su agente personalizado <b>Manoela Firvida</b></h2>
    ...
    <div class="row shadow-lg p-3 mb-5 ColorPrincipal RadioDeBordes">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-4 float-md-start">
            <img class="img-fluid RadioDeBordes" src="app/views/assets/img/ImagenesAgentes/ManoelaFirvida.png">
        </div>
    </div>
</div><br><br><br>
