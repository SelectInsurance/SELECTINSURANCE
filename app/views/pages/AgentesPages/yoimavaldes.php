                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 RadioDeBordes ColorPrincipalTranslucido">
                            <div class="container"><br><br>
                                ...
                                <form action="./yoimavaldes" method="post">
                                    <div class="row">
...
<div class="container" id="Cotizador">
    <h2 class="text-center ColorTextoOscuro">Cotiza con su agente personalizado <b>YOIMA VALDES</b></h2>
</div>
<div class="container" id="Servicios">
    <div class="row shadow-lg p-3 mb-5 ColorPrincipal RadioDeBordes">
        <div class="col-12 col-sm-6 col-md-4 col-lg-4">
            ...
            <center>
                <a type="button" class="btn btn-primary btn-lg" href="https://www.healthsherpa.com/?_agent_id=yoima-valdes-seti2w" target="__blank">
                    Cotizacion Salud
                </a>
            </center>
        </div>
...
<div class="container">
    <div class="row ColorPrincipal text-center RadioDeBordes">
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
            <img src="app/views/assets/img/ImagenesAgentes/WhatsApp Image 2021-08-11 at 12.10.09 PM.jpeg" class="RadioDeBordes img-fluid my-4" alt="Yoima Valdes" title="Agente de Seguros Yoima Valdes">
        </div>
    </div>
</div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3 col-lg-3">
                ...
                <p class="lh-lg">
                    Whatsapp: 9152729719 <br>

                    Telefono: <a href="tel:3057536828" title="Telefono">3057536828</a> <br>

                    Email: <a href="mailto:yvaldes.selectinsurance@gmail.com">yvaldes.selectinsurance@gmail.com</a> <br>

                    Dirección: 7791 NW 46 ST. SUITE 112 DORAL, FL 33166 <br>

                    Redes:
                <p><a href="https://www.instagram.com/ayudando_a_familias/" title="Mi Instagram" target="__blank"><i class="fab fa-instagram fa-2x"></i></a> <a href="https://www.facebook.com/tuagenteconfiable" title="Mi Facebook" target="__blank"><i class="fab fa-facebook fa-2x"></i></a></p> <br>
                </p>
            </div>
...
<blockquote>
    <a href="https://api.whatsapp.com/send?phone=9152729719" target="__blank">
        <p>
