...
class SubidaArchivos extends Pather
{
    ...
    public function SubidaImagenes($path, $filetmp, $file, $NombrePagina, $id)
    {
        ...
        $this->Conexion()->query("INSERT INTO ImagenAgente(Nombre, URL, NombrePagina, idPagina) VALUES('$file','$path','$NombrePagina','$id')");
    }
}
